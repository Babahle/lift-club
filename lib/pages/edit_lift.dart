...
class EditLiftView extends StatefulWidget {
  const EditLiftView({super.key, required this.lift});

  final Lift lift;
  @override
  State<EditLiftView> createState() => _EditLiftViewState();
}

class _EditLiftViewState extends State<EditLiftView> {
  ...
  late DateTime selectedDate = widget.lift.departureDateTime;
  late TimeOfDay? time;
  ...
  Widget build(BuildContext context) {
    _departureStreet.text = widget.lift.departureStreet;
    _departureTown.text = widget.lift.departureTown;
    _destinationStreet.text = widget.lift.destinationStreet;
    _destinationTown.text = widget.lift.destinationTown;
    _numberOfSeats.text = widget.lift.seatsAvailable.toString();
    _dateController.text =
        "${DateFormat.yMMMMEEEEd().format(widget.lift.departureDateTime)}, ${DateFormat.Hm().format(widget.lift.departureDateTime)}";
